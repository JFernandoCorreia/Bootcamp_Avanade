...
//Objetos para calcular a velocidade final do robô após uma sequência de comandos.Crie uma classe chamada "Robo" que possua
...
//Entrada
//A entrada consiste em duas linhas: A primeira linha contém dois inteiros Vmin e Vmax (1 ≤ Vmin < Vmax ≤ 100), representando
//a velocidade mínima e máxima do robô, respectivamente.
//A segunda linha contém uma sequência de comandos (com no máximo 100 caracteres), onde: 'A' representa uma aceleração e 'D'
//representa uma desaceleração. Desta maneira, a entrada seria da seguinte maneira:
