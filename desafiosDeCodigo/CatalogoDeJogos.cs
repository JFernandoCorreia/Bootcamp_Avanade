...
//em um array chamado nomesJogos. Utilize um loop `for` para facilitar a adição dos jogos. Após a conclusão, exiba um
//resumo em uma única linha, indicando a quantidade total de jogos adicionados e a lista de nomes no catálogo.
...
class Program
{
    static void Main()
    {
        ...
        // Cria um Loop para adicionar jogos conforme a quantidade especificada:
    ...
    {
        // Cria uma string com os nomes dos jogos separados por vírgulas
        string nomesJogos = string.Join(", ", nomes);

        // Exibe o resumo
        Console.WriteLine($"Foi adicionado '{quantidadeJogos}' jogos: {nomesJogos} ao catalogo.");
    }
}
